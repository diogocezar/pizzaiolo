...
export const pullRequestMock: PullRequestPayload = {
  ...
  pull_request: {
    ...
    created_at: new Date('2019-05-15T15:20:33Z'),
    updated_at: new Date('2019-05-15T15:20:33Z'),
    closed_at: null,
    merged_at: null,
    assignee: null,
    assignees: [],
  ...
  repository: {
    ...
    deployments_url:
      'https://api.github.com/repos/Codertocat/Hello-World/deployments',
    created_at: new Date('2019-05-15T15:19:25Z'),
    updated_at: new Date('2019-05-15T15:19:27Z'),
    pushed_at: new Date('2019-05-15T15:20:32Z'),
    git_url: 'git://github.com/Codertocat/Hello-World.git',
    ssh_url: 'git@github.com:Codertocat/Hello-World.git',
    clone_url: 'https://github.com/Codertocat/Hello-World.git',
    svn_url: 'https://github.com/Codertocat/Hello-World',
